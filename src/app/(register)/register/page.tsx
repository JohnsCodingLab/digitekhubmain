    ...
    return (
        ...
        >
            ...
            <div className="relative py-12 px-4 text-center overflow-hidden max-w-3xl mx-auto">
                ...
                >
                    Fill out the configuration profiles below to schedule your
                    high-speed fiber terminal deployment.
                </motion.p>
            </div>
                ...
                <AnimatePresence mode="wait">
                    {!isSuccess ? (
                        ...
                        >
                            ...
                            >
                                <div className="text-xs font-bold text-[var(--color-brand)] uppercase tracking-widest border-b pb-3 mb-6 flex items-center gap-2.5 border-dashed border-slate-200 dark:border-white/10">
                                    <FaUser size={14} /> Personal Information
                                </div>
                            ...
                            >
                                <div className="text-xs font-bold text-[var(--color-brand)] uppercase tracking-widest border-b pb-3 mb-6 flex items-center gap-2.5 border-dashed border-slate-200 dark:border-white/10">
                                    <FaWifi size={14} /> Select Internet Plan
                                </div>
                            ...
                            >
                                ...
                                >
                                    <p>
                                        ...
                                        installation upon activation. This plan
                                        requires a minimum commitment of twelve
                                        (12) months, with subscription fees
                                        payable on a monthly basis throughout
                                        the contract period. During this time,
                                        the Company will provide stable and
                                        unlimited internet service, subject to
                                        network availability and fair usage
                                        standards. Early cancellation before the
                                        completion of the 12-month term may
                                        attract device retrieval.
                                    </p>
                                    <p>
                                        <strong className="text-[var(--color-brand)] font-semibold">
                                            Non-Contract Plan:
                                        ...
                                        choose the Non-Contract Plan by paying a
                                        one-time installation fee of ₦85,000.
                                        This option does not require a long-term
                                        commitment, and renewals can be made at
                                        the customer&apos;s discretion. By
                                        clicking &quot;Agree&quot; and
                                        submitting this form, you acknowledge
                                        that you have read, understood, and
                                        accepted the terms of your selected
                                        plan.
                                    </p>
                                </div>
                        ...
                        >
                            ...
                            >
                                Thank you for registering. We have received your
                                application and will be in touch shortly to
